...
@click.option('--images_csv',default='source/images_2016_08_v5/validation/images.csv')
@click.option('--label_csv',default='source/machine_ann_2016_08_v3/validation/labels.csv')
